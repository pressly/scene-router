...
let useNativeDrive = false
export const enableNativeDrive = (value) => {
  useNativeDrive = value
}
...
export const scene = (opts = {}) => (Wrap) => {
  ...
  class Scene extends Component {
    ...
    setSceneStatus = (sceneStatus) => {
      if (this.wrapRef && this.wrapRef.updateSceneStatus) {
        this.wrapRef.updateSceneStatus(sceneStatus)
      }
    }
    ...
    render() {
      const { position, panResponder, opacity, backgroundColor } = this.state
