...
class Camera extends Component {
  ...
  render() {
    ...
    return (
      <View key="container" ref="container" style={[styles.container, { width }]}>
        {this.wrapCamera(
          <Animated.View key="scenes" style={[styles.camera, { width, transform: this._position.getTranslateTransform() }]}>
