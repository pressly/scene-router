...
class Camera extends Component {
  ...
  render() {
    ...
    return (
      <View ref="container" style={[styles.container, { width }]} onLayout={e => console.log('outer', e.nativeEvent.layout)}>
        {this.renderBack()}
        <Animated.View onLayout={e => console.log('inner', e.nativeEvent.layout)} style={[styles.camera, { width,
